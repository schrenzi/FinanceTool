...
OUTING_CATEGORIES = [
    ...
    ("lebensmittel", "Lebensmittel", "bi-cart3"),
    ("snacks", "Snacks", "bi-cookie"),
    ("vergnuegen", "Vergnügen", "bi-emoji-smile"),
    ("fortgehen", "Fortgehen", "bi-moon-stars"),
    ("ausflug", "Ausflug", "bi-geo-alt"),
    ("urlaub", "Urlaub", "bi-airplane"),
    ("wohnung", "Wohnung", "bi-house-door"),
    ("mobilitaet", "Mobilität", "bi-bicycle"),
    ("kleidung", "Kleidung", "bi-bag"),
    ("digitale_geraete", "Digitale Geräte", "bi-laptop"),
